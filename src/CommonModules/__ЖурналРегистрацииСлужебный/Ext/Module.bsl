...
// См. __ЖурналРегистрации.ДобавитьСообщениеДляЖурналаРегистрации.
...
Функция ПолучитьМодуль()
	Возврат __ОбщегоНазначенияПовтИсп.ПолучитьОбщийМодуль("ЖурналРегистрации", "__ЖурналРегистрации");
КонецФункции
