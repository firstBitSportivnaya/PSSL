...
//  Параметры	 - ТаблицаЗначений - см. __ОбщегоНазначенияСервер.КонструкторПараметровПользовательскойФункции
// 
// Возвращаемое значение:
...
// 
// Возвращаемое значение:
//  ТаблицаЗначений - Шаблон таблицы параметров пользовательской функции
//     * Номер - Число - Порядок параметров
//     * Параметр - Строка - Имя параметра
//     * Значение - Произвольный - Передаваемое значение параметра
//
Функция КонструкторПараметровПользовательскойФункции() Экспорт
	
	ТаблицаПараметров = Новый ТаблицаЗначений;
	ТаблицаПараметров.Колонки.Добавить("Номер", __ОбщегоНазначенияСлужебный.ОписаниеТипаЧисло(10,0));
	ТаблицаПараметров.Колонки.Добавить("Параметр", __ОбщегоНазначенияСлужебный.ОписаниеТипаСтрока(200));
