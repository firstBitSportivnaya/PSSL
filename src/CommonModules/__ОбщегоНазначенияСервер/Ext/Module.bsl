...
//  Параметры	 - Структура - Подставляемые значения
//   * Ключ - Строка - Имя параметра;
...
//   * Необязательный - Булево - Если Необязательный = Ложь и параметра нет в структуре параметров, то функция не будет выполнена
//   * Тип - Строка - Представление типа значения параметра
//  Отказ		 - Булево
//
Функция ПодставитьПараметрыВФункцию(Текст, ПараметрыФункции, Выборка, Отказ = Ложь)

	Параметры = Новый Структура;
	Пока Выборка.Следующий() Цикл
		Значение = Неопределено;
		Если ПараметрыФункции.Свойство(Выборка.Наименование, Значение) Тогда
		...
		Параметры.Вставить(Выборка.Наименование, Значение.Значение);
