...
Функция ПолучитьЗначения(Идентификаторы, ВРазрезеКлючей = Ложь) Экспорт
	...
	МассивИдентификаторов = __СтроковыеФункцииСлужебныйКлиентСервер.РазложитьСтрокуВМассивПодстрок(Идентификаторы);
	МассивИдентификаторов = __ОбщегоНазначенияСлужебныйКлиентСервер.СвернутьМассив(МассивИдентификаторов);
	...
	Если Не ВРазрезеКлючей Тогда
		Значения = __ОбщегоНазначенияСлужебныйКлиентСервер.СвернутьМассив(Значения);
	КонецЕсли;
	...
	Если МножественныйВыбор Тогда
		...
		Иначе
			Если ТипЗнч(Значение) = Тип("Массив") Тогда
				__ОбщегоНазначенияСлужебныйКлиентСервер.ДополнитьМассив(Приемник, Значение);
			Иначе
...
Функция ПолучитьПарольПоИдентификатору(УИД)
	...
	ДанныеХранилища = __ОбщегоНазначенияСлужебный.ПрочитатьДанныеИзБезопасногоХранилища(Строка(УИД));
	
	Значение = "";
	Если ТипЗнч(ДанныеХранилища) = Тип("Структура") Тогда
		Значение = __ОбщегоНазначенияСлужебныйКлиентСервер.СвойствоСтруктуры(ДанныеХранилища, "bit_password", "");
	КонецЕсли;
