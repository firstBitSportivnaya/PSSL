...
//   Алгоритм - ХешФункция - SHA256, SHA512, SHA1 или MD5.
//
// Возвращаемое значение:
...
Функция HMAC(Ключ, Данные, Алгоритм) Экспорт
	...
	Если Алгоритм = ХешФункция.SHA512 Тогда
		
		ДлинаБлока = 128;
		
	ИначеЕсли Алгоритм = ХешФункция.SHA256
		Или Алгоритм = ХешФункция.SHA1
		Или Алгоритм = ХешФункция.MD5 Тогда
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Неподдерживаемый алгоритм HMAC: %1. Допустимы SHA256, SHA512, SHA1 и MD5.'"),
			Строка(Алгоритм));
