...
Процедура ДополнительноОбработатьЗапросыИнтеграцииПередЗаписьюВИсторию(СтруктураЗаписиИстории)
	...
	ТипИнтеграции = пбп_Переадресация.ЗначениеРеквизитаОбъекта(СтруктураЗаписиИстории.ИнтеграционныйПоток,
		"НастройкаИнтеграции.ТипИнтеграции");
	
	Если ТипИнтеграции = Справочники.пбп_ТипыИнтеграций.SFTP
		Или ТипИнтеграции = Справочники.пбп_ТипыИнтеграций.КоманднаяСтрока Тогда
		Возврат;
	КонецЕсли;
