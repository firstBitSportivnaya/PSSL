...
Процедура СгенерироватьПротоколОбменаПоОбъектамИнтеграции(СтруктураЗаписиИстории)
	...
	Для Каждого СтрокаОбъекта Из СтруктураЗаписиИстории.ОбъектыИнтеграции Цикл
		...
		Если СтрокаОбъекта.СозданОбновлен = Перечисления.пбп_СозданОбновлен.Создан
			...
			ТекстСообщения = ПолучитьТекстСообщенияСозданОбновлен(СтрокаОбъекта, НаименованияТипов);		ИначеЕсли СтрокаОбъекта.СозданОбновлен = Перечисления.пбп_СозданОбновлен.ОшибкаСоздания
			Или СтрокаОбъекта.СозданОбновлен = Перечисления.пбп_СозданОбновлен.ОшибкаОбновления Тогда
			ТекстСообщения = ПолучитьТекстСообщенияОшибкаСозданияОшибкаОбновления(СтрокаОбъекта, НаименованияТипов);		Иначе			ВызватьИсключение НСтр("ru = 'Не заполнен тип операции ""Создан/обновлен""';")		КонецЕсли;
