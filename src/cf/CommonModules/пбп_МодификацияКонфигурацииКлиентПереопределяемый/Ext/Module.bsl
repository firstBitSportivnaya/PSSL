...
Процедура ПриОткрытии(Форма, Отказ) Экспорт
	...
	Если Не ЭтоКлиентПриложения() Тогда
		Возврат;
	КонецЕсли;
...
Функция ЭтоКлиентПриложения()
	
#Если Клиент Или ТолстыйКлиентУправляемоеПриложение Или ТонкийКлиент Тогда
	Возврат Истина;
#Иначе
	Возврат Ложь;
#КонецЕсли
...
Процедура ВызватьМетод(ИмяМетода, Параметры)
	...
	Попытка
	#Если Не ВебКлиент И Не МобильноеПриложение Тогда
