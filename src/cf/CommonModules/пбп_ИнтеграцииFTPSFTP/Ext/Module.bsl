...
//  ПроверитьНаличиеПередУдалением - если Истина, то перед удалением будет выполнена проверка наличия файла
//  СтруктураИстории    - Структура - см. ПолучитьСтруктуруЗаписиИстории
// 
// Возвращаемое значение:
//  Строка - описание ошибки
//
Функция УдалитьФайлSFTP(ИнтеграционныйПоток, ИмяФайла, КаталогФайла = "/",
	ПроверитьНаличиеПередУдалением = Истина, СтруктураИстории = Неопределено) Экспорт
