...
// Описание см. в пбп_ПредопределенныеЗначения.ПредопределенныйЭлемент.
//
Функция ПредопределенныеЭлементы(Знач ИмяОбъектаМетаданных, Знач Идентификатор, ВыбрасыватьИсключение = Ложь, ЗначениеПоУмолчанию = Неопределено) Экспорт
...
// Описание см. в пбп_ПредопределенныеЗначения.ЗначениеПредопределенногоЭлемента.
//
Функция ЗначенияПредопределенныхЭлементов(Знач ИмяОбъектаМетаданных, Ссылки, ВыбрасыватьИсключение = Ложь, ЗначениеПоУмолчанию = Неопределено) Экспорт
	
	Менеджер = пбп_Переадресация.МенеджерОбъектаПоПолномуИмени(ИмяОбъектаМетаданных);
	
	Возврат Менеджер.ПолучитьЗначения(Ссылки, ВыбрасыватьИсключение, ЗначениеПоУмолчанию);
