...
Функция ОписаниеТипаТаблицаЗначений() Экспорт
	...
	Возврат Новый ОписаниеТипов(__ОбщегоНазначенияСлужебныйКлиентСервер.ЗначениеВМассиве(Тип("ТаблицаЗначений")));
...
Функция ОписаниеТипаДинамическийСписок() Экспорт
	...
	Возврат Новый ОписаниеТипов(__ОбщегоНазначенияСлужебныйКлиентСервер.ЗначениеВМассиве(Тип("ДинамическийСписок")));
...
Процедура УдалитьРеквизит(Форма, ИмяРеквизита) Экспорт
	...
	УдалитьРеквизиты(Форма, __ОбщегоНазначенияСлужебныйКлиентСервер.ЗначениеВМассиве(ИмяРеквизита));
...
Процедура УдалитьЭлемент(Форма, ИмяЭлемента) Экспорт
	...
	УдалитьЭлементы(Форма, __ОбщегоНазначенияСлужебныйКлиентСервер.ЗначениеВМассиве(ИмяЭлемента));
