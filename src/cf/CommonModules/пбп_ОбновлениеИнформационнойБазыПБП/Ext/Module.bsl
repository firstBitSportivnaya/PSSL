...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "пбп_ОбновлениеИнформационнойБазыПБП.УстановитьЗначенияКонстанты_1_0_8_0";
...
Процедура УстановитьЗначенияКонстанты_1_0_8_0() Экспорт
	
	Если Константы.пбп_ПериодПроверкиСостоянияСервераОповещенийВСекундах.Получить() = 0 Тогда
		Константы.пбп_ПериодПроверкиСостоянияСервераОповещенийВСекундах.Установить(1200);
	КонецЕсли;
