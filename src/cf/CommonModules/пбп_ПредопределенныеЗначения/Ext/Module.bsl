...
//
// Параметры:
//  ИсточникМетаданных		 - СправочникМенеджер, ПланВидовХарактеристикМененджер, ПланСчетовМенеджер, ПланВидовРасчетовМенеджер, Строка	 - источник, по которому определяется объект метаданных с предопределёнными элементами.
//                             Для Строки ожидается полное имя объекта в синтаксисе 1С (например, "Справочник.Номенклатура",
//                             "ПланСчетов.Хозрасчетный"). Для менеджера используется его тип (например,
...
//  ИспользоватьКеш			 - Булево - признак получения данных из кэша.
...
//                             которое возвращается, если предопределенного не существует. Если не указано, возвращается значение Неопределено.
// 
// Возвращаемое значение:
...
//
Функция ПредопределенныйЭлемент(ИсточникМетаданных, Знач Идентификатор, ВыбрасыватьИсключение = Ложь, ЗначениеПоУмолчанию = Неопределено, ИспользоватьКэш = Ложь) Экспорт
	...
	Возврат ПолучитьПредопределенныеПоИдентификаторам(ИмяОбъектаМетаданных, Идентификатор, Значение, , ВыбрасыватьИсключение);
...
//
Функция ПредопределенныеЭлементы(ИсточникМетаданных, Знач Идентификаторы, ВыбрасыватьИсключение = Ложь, ВРазрезеКлючей = Ложь) Экспорт
	...
	Возврат ПолучитьПредопределенныеПоИдентификаторам(ИмяОбъектаМетаданных, Идентификаторы, Значения, Истина, ВыбрасыватьИсключение);
...
//
Функция ЗначениеПредопределенногоЭлемента(ИсточникМетаданных, Ссылка, ВыбрасыватьИсключение = Ложь, ЗначениеПоУмолчанию = Неопределено, ИспользоватьКэш = Ложь) Экспорт
...
//
Функция ЗначенияПредопределенныхЭлементов(ИсточникМетаданных, Ссылки, ВыбрасыватьИсключение = Ложь, ВРазрезеКлючей = Ложь) Экспорт
...
Функция ПолучитьПредопределенныеПоИдентификаторам(ИмяОбъектаМетаданных, Знач Идентификаторы, Знач Результат, МножественныйВыбор = Ложь, ВыбрасыватьИсключение = Ложь) Экспорт
