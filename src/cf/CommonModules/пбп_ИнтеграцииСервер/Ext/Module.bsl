...
//
Функция ПолучитьТокеныИнтегрируемойСистемы(ИнтегрируемаяСистема, Организация = Неопределено, Пользователь = Неопределено) Экспорт
	...
	Возврат РегистрыСведений.пбп_ТокеныИнтегрируемыхСистем.ПолучитьЗаписи(
		ИнтегрируемаяСистема, Организация, Пользователь);
