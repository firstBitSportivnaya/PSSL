...
Функция КонвертироватьЗапросТипаMultipartFormData(Запрос,
	...
	Исключение
		...
		Если ЗначениеЗаполнено(СтруктураИстории) Тогда
			СтруктураИстории.ОписаниеОшибки = ТекстОшибки;
		КонецЕсли;
...
Функция ПрочитатьСообщениеСоставногоЗапроса(Заголовки, Тело,
	...
	Маркеры.Добавить(СимволыРазделителя + Разделитель);
	Маркеры.Добавить(СимволыРазделителя + Разделитель + Символы.ПС);
	Маркеры.Добавить(СимволыРазделителя + Разделитель + Символы.ВК);
	Маркеры.Добавить(СимволыРазделителя + Разделитель + Символы.ВК + Символы.ПС);
	Маркеры.Добавить(СимволыРазделителя + Разделитель + СимволыРазделителя);
	...
	Пока Истина Цикл
		...
		ИмяЧасти = ПолучитьИмяСообщенияСоставногоЗапроса(ЗаголовкиЧасти);
