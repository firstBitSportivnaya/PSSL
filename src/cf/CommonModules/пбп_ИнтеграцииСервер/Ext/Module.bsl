...
//
Процедура СоздатьИзменитьОжиданиеАсинхронногоВызова(ИдентификаторСообщения, Изменение = Ложь,
	ИсходящееСообщение = Неопределено, Статус = Неопределено, ДатаВызова = Неопределено, ОписаниеОшибки = "") Экспорт
