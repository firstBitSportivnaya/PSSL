...
//
// Параметры:
//  ИнтегрируемаяСистема		 - Строка - уникальный идентификатор сообщения обмена
//  Изменение					 - Булево - изменить или создать запись
//  ИдентификаторСистемы			 - СправочникСсылка.пбп_ИсторияИнтеграции - история интеграции исх. сообщения
//  ДополнительныйИдентификатор	 - ПеречислениеСсылка.пбп_СтатусыАсинхронныхВызовов - статус вызова
//  Изменение					 - Булево - изменить или создать запись
//
...
//  ИдентификаторСообщения	 - Строка	 - идентификатор сообщения обмена
//
Процедура УдалитьСоответствиеОбъектовИнтегрируемыхСистем(ИдентификаторСообщения) Экспорт
