...
Функция ПолучитьСсылкуНаОбъектПоИдентификаторуСистемы(ИнтегрируемаяСистема, Идентификатор,
	...
	Возврат пбп_ИнтеграцииСлужебный.ПолучитьСсылкуНаОбъектПоИдентификаторуСистемы(
		ИнтегрируемаяСистема, Идентификатор, ИнтеграционныйПоток);
...
Функция ПолучитьДополнительныеИдентификаторыИзСоответствияОбъектовСистем(ИнтегрируемаяСистема, МассивСсылок,
	...
	Возврат пбп_ИнтеграцииСлужебный.ПолучитьДополнительныеИдентификаторыИзСоответствияОбъектовСистем(
		ИнтегрируемаяСистема, МассивСсылок, ИнтеграционныйПоток);
...
Процедура СоздатьИзменитьСоответствиеОбъектовИнтегрируемыхСистем(ИнтегрируемаяСистема,
	СсылкаНаОбъект, ИдентификаторСистемы, ДополнительныйИдентификатор = "",
	ИнтеграционныйПоток = Неопределено, Изменение = Ложь) Экспорт
...
Процедура УдалитьСоответствиеОбъектовИнтегрируемыхСистем(ИнтегрируемаяСистема,
	СсылкаНаОбъект = Неопределено, ИдентификаторСистемы = Неопределено,
	ИнтеграционныйПоток = Неопределено) Экспорт
	...
	Если ЗначениеЗаполнено(ИнтеграционныйПоток) Тогда
		ПараметрыУдаления.Вставить("ИнтеграционныйПоток", ИнтеграционныйПоток);
	КонецЕсли;
