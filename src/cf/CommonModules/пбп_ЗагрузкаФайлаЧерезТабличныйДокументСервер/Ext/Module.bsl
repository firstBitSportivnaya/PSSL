	...
	Для Каждого СтрокаТаблицы Из ТЗ Цикл
		...
		Для Каждого ИмяКолонкиБулево Из МассивИменКолонокБулево Цикл
			Если ПустаяСтрока(ЗначениеИстина) Тогда
				СтрокаТаблицы[ИмяКолонкиБулево] = НРег(СтрокаТаблицы[ИмяКолонкиБулево + "Строкой"]) = "да"
					Или НРег(СтрокаТаблицы[ИмяКолонкиБулево + "Строкой"]) = "истина";
			Иначе
				СтрокаТаблицы[ИмяКолонкиБулево] = НРег(СтрокаТаблицы[ИмяКолонкиБулево + "Строкой"]) = НРег(ЗначениеИстина);
			КонецЕсли;
		КонецЦикла;
