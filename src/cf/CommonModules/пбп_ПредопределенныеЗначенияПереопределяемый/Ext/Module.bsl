...
//             Пустая таблица каркас, см. пбп_ПредопределенныеЗначенияПереопределяемый.ТаблицаПредопределенныхЭлементов
// 
// Возвращаемое значение:
...
Функция ТаблицаКонфликтныхЭлементов(Менеджер, ИсходнаяТаблица = Неопределено) Экспорт
	...
	ИсходнаяТаблица.Колонки.Добавить("Служебный_КоллизииИдентификаторов", Новый ОписаниеТипов("Булево"));
