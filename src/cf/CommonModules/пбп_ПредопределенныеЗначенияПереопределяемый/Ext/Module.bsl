...
Процедура ПредопределенныеЗначения(Таблица) Экспорт
	...
	НоваяНастройка.ИдентификаторРодитель = "Интеграции_локал";
...
// 
// Возвращаемое значение:
//  Структура - Структура из КлючИЗначение:
//   * Ключ - Строка,
...
Функция ОбщиеКолонки(Менеджер)
	...
	ОписаниеТиповПредопред = Новый ОписаниеТипов(массив);
	...
	Колонки.Вставить("Родитель", ОписаниеТиповПредопред);
	...
	Колонки.Вставить("Служеб_ПредопределенныйЭлемент", ОписаниеТиповПредопред);
	// ++
