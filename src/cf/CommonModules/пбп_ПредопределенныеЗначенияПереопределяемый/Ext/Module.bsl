...
//  Структура - Где ключ имя колонки, значение описание типов колонки
//
Функция ДобавляемыеПоляДляРасчетаТипСоответствияОбъектовИБ() Экспорт
...
Функция СтандартныеПоля() Экспорт
	...
	Поля.Добавить("ЭтоПредопределенный");
