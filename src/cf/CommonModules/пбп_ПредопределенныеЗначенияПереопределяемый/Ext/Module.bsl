...
Процедура ПредопределенныеЗначения(Таблица) Экспорт
	...
	НоваяНастройка = Таблица.Добавить();
	НоваяНастройка.Наименование = "Серверные оповещения";
	НоваяНастройка.ИдентификаторНастройки = "СерверныеОповещения";
	НоваяНастройка.ЭтоГруппа = Истина;
	НоваяНастройка.УровеньИерархии = 0;
	
	НоваяНастройка = Таблица.Добавить();
	НоваяНастройка.Наименование = "Период проверки состояния сервера оповещений в секундах";
	НоваяНастройка.ИдентификаторНастройки = "ПериодПроверкиСостоянияСервераОповещенийВСекундах";
	НоваяНастройка.ТипЗначения = ОписаниеЧисло;
	НоваяНастройка.ИдентификаторРодитель = "СерверныеОповещения";
