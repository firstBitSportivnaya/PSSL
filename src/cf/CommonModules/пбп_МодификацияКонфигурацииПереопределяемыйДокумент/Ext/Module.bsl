...
Процедура ДемоРаботаСФормамиФормаДокументаПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка, ДополнительныеПараметры = Неопределено) Экспорт
	...
	СтруктураРеквизитов.Вставить("_ДемоДата",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаДатаВремя()));
	СтруктураРеквизитов.Вставить("_ДемоНомер",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаСтрока(11)));
	СтруктураРеквизитов.Вставить("_ДемоПокупатель",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаСправочник("_ДемоКонтрагенты")));
	СтруктураРеквизитов.Вставить("_ДемоПлатнаяДоставка",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаБулево()));
	СтруктураРеквизитов.Вставить("_ДемоТолькоБудни",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаБулево()));
	СтруктураРеквизитов.Вставить("_ДемоПолКурьера",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаПеречисление("_ДемоПолФизическогоЛица")));
	СтруктураРеквизитов.Вставить("_ДемоТовары",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаТаблицаЗначений()));
	СтруктураРеквизитов.Вставить("_ДемоКомментарий",
		Новый Структура("ОписаниеТипа", пбп_РаботаСФормами.ОписаниеТипаСтрока(100)));
