...
Асинх Процедура СформироватьОбработкуОтладкиПослеЗаполненияПараметров(
	...
	Если ЗначениеЗаполнено(КаталогВременныхФайлов) Тогда
		...
		ОбработатьМодульОбъектаОбработкиОтладкиЗаполнитьПараметры(ПутьКФайлуМодуля, СтруктураПараметров);
...
&НаКлиенте
Асинх Процедура ОбработатьМодульОбъектаОбработкиОтладкиЗаполнитьПараметры(ПутьКФайлуМодуля, СтруктураПараметров)
	
	ТекстовыйФайл = Новый ТекстовыйДокумент;
	Результат = Ждать ТекстовыйФайл.ПрочитатьАсинх(ПутьКФайлуМодуля);
	Если Результат <> Неопределено Тогда
		...
		Ждать ТекстовыйФайл.ЗаписатьАсинх(ПутьКФайлуМодуля);
	КонецЕсли;
