...
Асинх Процедура СформироватьОбработкуОтладкиПослеЗаполненияПараметров(
	...
	Если ЗначениеЗаполнено(КаталогВременныхФайлов) Тогда
		...
		АдресОбработкиВХранилище = Ждать ПолучитьПутьКНовойОбработкеОтладки(ПараметрыСохранения, КаталогДляАрхива, ИмяОбработки);
...
&НаКлиенте
Асинх Функция ПолучитьПутьКНовойОбработкеОтладки(ПараметрыСохранения, КаталогДляАрхива, ИмяОбработки)
