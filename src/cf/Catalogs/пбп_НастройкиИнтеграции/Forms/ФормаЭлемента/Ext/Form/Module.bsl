...
Процедура ПодключитьВнешнююКомпонентуИзФайла(Команда)
	...
	Оповещение = Новый ОписаниеОповещения("ОбработчикПодключенияВнешнейКомпонентыЗавершениеПослеВыбораКомпоненты", ЭтотОбъект);
...
Процедура УстановитьСвойстваЭлементов()
	...
	Если Не ЗначениеЗаполнено(Объект.ТипИнтеграции) Тогда
		...
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ГруппаОсновныеНастройки", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "УчетнаяЗапись", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ТипАвторизации", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ИмяCOMОбъекта", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ИспользоватьПользовательскиеФункции", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "СписокНастроек", "Видимость", Ложь);
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ПодключитьВнешнююКомпоненту", "Видимость", Ложь);
	Иначе
		пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы, "ГруппаОсновныеНастройки", "Видимость", Истина);
		...
		Если ЭлементНаследованиия = Справочники.пбп_ТипыИнтеграций.Каталог Тогда
			...
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "СтрокаПодключения", "Видимость", Истина);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		ИначеЕсли ЭлементНаследованиия = Справочники.пбп_ТипыИнтеграций.FTPРесурсы Тогда
			...
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "УчетнаяЗапись", "Видимость", Ложь);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "СписокНастроек", "Видимость", Истина);
		...
		ИначеЕсли ЭлементНаследованиия = Справочники.пбп_ТипыИнтеграций.ПочтовыйКлиент Тогда
			...
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "СтрокаПодключения", "Видимость", Ложь);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "Порт", "Видимость", Ложь);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		ИначеЕсли ЭлементНаследованиия = Справочники.пбп_ТипыИнтеграций.COM Тогда
			...
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "ТипАвторизации", "Видимость", Ложь);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "ИмяCOMОбъекта", "Видимость", Истина);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "СписокНастроек", "Видимость", Истина);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "ПодключитьВнешнююКомпоненту", "Видимость", Ложь);
		...
		ИначеЕсли ЭлементНаследованиия = Справочники.пбп_ТипыИнтеграций.ВнешняяКомпонента Тогда
			...
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "СписокНастроек", "Видимость", Ложь);
			пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы, "ПодключитьВнешнююКомпоненту", "Видимость", Истина);
...
Процедура УстановитьВидимостьЭлементовДляТипаФайловыеОбмены()
	...
	пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ИмяCOMОбъекта", "Видимость", Ложь);
	пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ИспользоватьПользовательскиеФункции", "Видимость", Истина);
	пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "СписокНастроек", "Видимость", Ложь);
	пбп_ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		Элементы, "ПодключитьВнешнююКомпоненту", "Видимость", Ложь);
...
&НаКлиенте
Процедура ОбработчикВыбораФайловогоКаталогаЗавершениеПослеВыбораВДиалоге(Результат, ДополнительныеПараметры = Неопределено) Экспорт
...
&НаКлиенте
Процедура ОбработчикПодключенияВнешнейКомпонентыЗавершениеПослеВыбораКомпоненты(Результат, ДополнительныеПараметры = Неопределено) Экспорт
...
&НаСервере
Процедура ОбработчикПодключенияВнешнейКомпонентыЗавершениеПослеВыбораКомпонентыНаСервере(Результат, ДополнительныеПараметры = Неопределено) Экспорт
...
Функция ПолучитьОбщиеЗначения()
	...
	Массив = Новый Массив;
	Если Не ЗначениеЗаполнено(Объект.ТипАвторизации) Или Объект.ТипАвторизации = Перечисления.пбп_ТипыАвторизации.Базовая Тогда
