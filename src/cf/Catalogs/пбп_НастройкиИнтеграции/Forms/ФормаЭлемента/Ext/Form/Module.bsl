...
&НаСервере
Процедура УстановитьДоступностьКнопкиПараметрыАутентификации()
	Элементы.СписокНастроекДобавитьОбщиеНастройки.Доступность =
		Не Объект.ТипАвторизации = Перечисления.пбп_ТипыАвторизации.БезАвторизации;
КонецПроцедуры

&НаКлиенте
Процедура ТипАвторизацииПриИзменении(Элемент)
	УстановитьДоступностьКнопкиПараметрыАутентификации();
КонецПроцедуры
