...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Объект.ТипАвторизации <> Перечисления.пбп_ТипыАвторизации.БезАвторизации Тогда
...
&НаСервере
Процедура ПрименитьДоступностьКнопкиПараметрыАутентификацииНаСервере()
...
Процедура ТипАвторизацииПриИзменении(Элемент)
	...
	УстановитьДоступностьКнопкиПараметрыАутентификации(Элементы, Объект.ТипАвторизации);
	ПрименитьДоступностьКнопкиПараметрыАутентификацииНаСервере();
	
	ТипБезАвторизации = ПредопределенноеЗначение("Перечисление.пбп_ТипыАвторизации.БезАвторизации");
	Если Объект.ТипАвторизации <> ТипБезАвторизации Тогда
	...
	Если Не ЕстьЗаполненныеПараметрыАутентификации() Тогда
