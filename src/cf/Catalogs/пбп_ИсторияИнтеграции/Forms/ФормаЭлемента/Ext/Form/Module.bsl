...
Процедура УстановитьСвойстваЭлементов()
	...
	Если пбп_ОбщегоНазначенияПовтИсп.ПолучитьИспользованиеВерсионированияОбъектовОбмена() Тогда
		Элементы.ОбъектыОбменаНомерВерсии.Видимость = Истина;
	Иначе
		Элементы.ОбъектыОбменаНомерВерсии.Видимость = Ложь;
	КонецЕсли;
