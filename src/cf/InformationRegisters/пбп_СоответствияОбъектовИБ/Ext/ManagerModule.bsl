...
//  Объект3 - ОпределяемыйТип.пбп_ТипыОбъектовСоответствийИБ - Объект3.
// 
// Возвращаемое значение:
//  - Массив - соответствие объектов ИБ в виде структур.
// 
Функция ПолучитьСоответствиеОбъектовИБ(ИдентификаторНастройки,
	Объект1 = Неопределено, Объект2 = Неопределено, Объект3 = Неопределено) Экспорт
	
	Запрос = ЗапросПолученияЗаписейРегистра(ИдентификаторНастройки, Объект1, Объект2, Объект3);
...
// 
Функция ПолучитьЗначенияОбъектаСоответствияПоКлючу(
	ИдентификаторНастройки, ИмяКлюча, ЗначениеКлюча, ИмяОбъекта) Экспорт
...
Функция ПолучитьЗначениеСоответствияОбъектов(ИдентификаторНастройки,
	Объект1 = Неопределено, Объект2 = Неопределено) Экспорт
	
	Запрос = ЗапросПолученияЗаписейРегистра(ИдентификаторНастройки, Объект1, Объект2);
	...
	Если ЗначениеЗаполнено(Объект1) И ЗначениеЗаполнено(Объект2)
		Или ЗначениеЗаполнено(Объект1) И Не ЗначениеЗаполнено(Объект2) Тогда
		ЗначениеСоответствия = ВыборкаРезультатаЗапроса.Объект3;
	Иначе
		ЗначениеСоответствия = ВыборкаРезультатаЗапроса.Объект2;
	КонецЕсли;
...
Функция ЗапросПолученияЗаписейРегистра(ИдентификаторНастройки, Объект1, Объект2, Объект3 = Неопределено, КоличествоЗаписей = 0)
	...
	Если ЗначениеЗаполнено(КоличествоЗаписей) Тогда
		ОператорВыбрать.КоличествоПолучаемыхЗаписей = КоличествоЗаписей;
	КонецЕсли;
