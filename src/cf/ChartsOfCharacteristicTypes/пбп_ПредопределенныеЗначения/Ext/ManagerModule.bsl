...
//
// Параметры:
//  Ссылка					 - ПланВидовХарактеристикСсылка.пбп_ПредопределенныеЗначения - ссылка на предопределенный элемент.
//  ВыбрасыватьИсключение	 - Булево - выбрасывать исключение, если есть ошибки.
//  ЗначениеПоУмолчанию		 - ПланВидовХарактеристикСсылка.пбп_ПредопределенныеЗначения, Неопределено - значение,
...
//
// Параметры:
//  Ссылки					 - Массив из ПланВидовХарактеристикСсылка.пбп_ПредопределенныеЗначения - ссылки
...
//
Функция ЗначенияПредопределенныхЭлементов(Знач Ссылки,
