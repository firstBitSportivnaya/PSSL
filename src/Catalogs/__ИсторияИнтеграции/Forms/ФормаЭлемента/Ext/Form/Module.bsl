...
Процедура ПриОткрытии(Отказ)
	...
	Если ЗначениеЗаполнено(Объект.ФорматЗапросаИнтеграции) 
		И Объект.ФорматЗапросаИнтеграции <> __ОбщегоНазначенияСлужебныйКлиент.ПредопределенныйЭлемент("Перечисление.__ФорматыЗапросовИнтеграции.ПроизвольныйФормат") Тогда
...
Процедура ЗапросИсходящийДокументСформирован_Подключаемый(Элемент)
	...
	Если Объект.ФорматЗапросаИнтеграции = __ОбщегоНазначенияСлужебныйКлиент.ПредопределенныйЭлемент("Перечисление.__ФорматыЗапросовИнтеграции.JSON") Тогда
...
Процедура РазвернутьВсе(Команда)
	...
	Если Объект.ФорматЗапросаИнтеграции = __ОбщегоНазначенияСлужебныйКлиент.ПредопределенныйЭлемент("Перечисление.__ФорматыЗапросовИнтеграции.XML") Тогда
