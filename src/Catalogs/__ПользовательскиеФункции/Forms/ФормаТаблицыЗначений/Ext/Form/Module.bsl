...
Процедура ОбновитьТаблицуСтрок()
	...
	РеквизитыТаблицы = ПолучитьРеквизиты("СтрокиТаблицыЗначений");
	...
	Для Каждого Реквизит Из РеквизитыТаблицы Цикл
		...
		Если ИменаКолонок.Найти(Реквизит.Имя) = Неопределено Тогда
			УдаляемыеРеквизиты.Добавить("СтрокиТаблицыЗначений." + Реквизит.Имя);
			__РаботаСФормами.УдалитьЭлемент(ЭтотОбъект, "СтрокиТаблицыЗначений" + Реквизит.Имя);
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого Колонка Из КолонкиТаблицыЗначений Цикл
		Если ИменаРеквизитов.Найти(Колонка.Имя) = Неопределено Тогда
			НовыйРеквизит = Новый РеквизитФормы(Колонка.Имя, Колонка.ТипЗначения, "СтрокиТаблицыЗначений");
	...
	Попытка
		...
		Таблица = "СтрокиТаблицыЗначений";
		Для Каждого Реквизит Из ДобавляемыеРеквизиты Цикл
			Если Элементы.Найти("СтрокиТаблицыЗначений" + Реквизит.Имя) = Неопределено Тогда
