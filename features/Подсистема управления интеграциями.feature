...
* Дозаполнение настройки интеграции
	...
	И из выпадающего списка с именем "ТипИнтеграции" я выбираю по строке 'sftp'
	И из выпадающего списка с именем "ИнтегрируемаяСистема" я выбираю по строке 'систе'
